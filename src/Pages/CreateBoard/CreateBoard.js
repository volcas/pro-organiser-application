...
class CreateBoard extends Component {
  ...
  componentDidMount = () => {
    Axios.get(
      "https://pro-organizer-f83b5.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/allBoards.json"
    )
      .then((response) => {
        this.setState({
    ...
    Axios.get(
      "https://pro-organizer-f83b5.firebaseio.com/boardData/-LuM4blPg67eyvzgAzwn/boards.json"
    )
      .then((response) => {
        this.setState({
    ...
    Axios.put(
      ...
      .then((response) => {
        Axios.put(
          ...
          .catch((error) => {
            console.log("Boards.json error ", error);
          });
      })
      .catch((error) => {
        console.log("allBoards.json error", error);
      });
  };
  ...
  render() {
    ...
    return (
      <div className={styles.CreateBoard}>
        ...
        <div className={styles.BoardForm}>{formElements}</div>
        <button
          id="CreateBoard"
