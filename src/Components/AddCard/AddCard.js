...
import boardStyles from "../../Pages/Board/Board";
  ...
  render() {
    let formElements = this.state.formElements.map((element) => {
      ...
      return (
        <FormElements
          ...
          reference={ref}
          key={element.id}
          options={element.id === "members" && this.props.members}
    ...
    return (
      <div className={styles.AddCard}>
        <p className={boardStyles.BoardTitle}>
          {this.props.editCard ? "Edit Card" : "Add Card"}
        </p>
        {formElements}
        <button
          id="CreateCard"
